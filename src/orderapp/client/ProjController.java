...
import orderapp.client.product;
...
//         System.out.println("the password is :" + s);
  ...
  Alert alert = new Alert(AlertType.ERROR);
    ...
    @FXML
    private void refreshvieworder(ActionEvent event) {
    }

    @FXML
    private void refreshviewprofile(ActionEvent event) {
    }

    @FXML
    private void refreshviewinvoices(ActionEvent event) {
    }
